...
必回复的反面是**必不回复**——群里绝大多数消息 bot 不该接话。我踩过的坑是把这个判断托付给了平台："反正平台只会把 @我 的消息投递给我，我自己不用校验。"后台把消息订阅范围从"仅 @我"放开到"全群消息"之后，这个隐式假设瞬间崩成刷屏——bot 对每条消息都应了一句。
...
- [长连接假活与漏事件对账：把"无解"的断连间隙变成可补偿的](21-connection-false-alive-reconciliation.md)
