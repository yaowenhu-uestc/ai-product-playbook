...
注意"没点名的安心跳过"也是价值：明确说"其他人可略过"，比让每个人自己纠结"要不要看"更尊重注意力。
...
| 👀 建议谁看 | 按相关性点名 + 一句理由 | 1~4 人，同类可分组；作者绝不点；其余明说可略过 | 注意力分配 |
...
一处一字之差的修订：点名行从"谁要看"改成"建议谁看"。前者是分派任务的语气，后者是提供建议的语气。bot 在团队群里的角色是参谋不是上级——**推送文案的语气，实际上定义了 bot 在组织里的权力位置**，这类措辞值得逐字抠。
