...
### [product-notes/](product-notes/README.md) — 产品手记与产品判断
...
### [agent/](agent/README.md) — Agent、Memory、Context、Workflow 实践
...
| 21 | [长连接假活与漏事件对账：把"无解"的断连间隙变成可补偿的](agent/21-connection-false-alive-reconciliation.md) | 连接"在线"≠事件在送达、同应用重复监听会抢占长连接、对账机制取代对连接可靠性的执念、修正此前"断连丢消息无解"的判断 |

### [prompts/](prompts/README.md) — 可复用 Prompt
...
### [resources/](resources/README.md) — 外部资源组织方式
