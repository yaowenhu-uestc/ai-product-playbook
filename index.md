...
<main class="home">
  ...
  <p class="visit-stats" aria-live="polite">累计阅读 <strong id="total-visits">—</strong> 次　今日 <strong id="today-visits">—</strong> 次</p>
...
<script>
  ...
  async function loadVisitStats() {
    try {
      ...
      const { total, today } = await response.json();
      document.querySelector("#total-visits").textContent = total;
      document.querySelector("#today-visits").textContent = today;
    } catch {}
  }
